...
export const PoliticasContent: React.FC = () => {
  return (
    <PoliticasContainer>
      ...
      <PoliticasText>
        A <PoliticasStrong>SF Empreendimentos</PoliticasStrong> valoriza a
      ...
      <PoliticasText>
        A <PoliticasStrong>SF Empreendimentos</PoliticasStrong> não vende ou
      ...
      <PoliticasSessionText>
        ...
        <PoliticasText>
          📧 E-mail: contato@sfempreendimentos.com.br
        </PoliticasText>
        <PoliticasText>🌐 Site: www.sfempreendimentos.com.br</PoliticasText>
      </PoliticasSessionText>
    </PoliticasContainer>
  );
};
