...
export const TermosContent: React.FC = () => {
  return (
    <TermosContainer>
      ...
      <TermosText>
        A <TermosStrong>SF Empreendimentos</TermosStrong> valoriza a privacidade
      ...
      <TermosText>
        A <TermosStrong>SF Empreendimentos</TermosStrong> não vende ou
      ...
      <TermosSessionText>
        ...
        <TermosText>📧 E-mail: contato@sfempreendimentos.com.br</TermosText>
        <TermosText>🌐 Site: www.sfempreendimentos.com.br</TermosText>
      </TermosSessionText>
    </TermosContainer>
  );
};
